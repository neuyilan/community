    ...
    <div class="wrapper wranews">
        <div class="newsrel">
            ...
            <div class="cont-l">
                ...
                <div style=" overflow:hidden;"><img id="cmhcPicBtn" src="${ctx}${businessChinmedichenacare.cmhcPic }" width="305" height="102" style="float:left; padding-right:10px;"><div style="color:#000; padding-top:26px;">请上传【宽600PX、高250PX】jpg格式图片<br>图片大小不能超过100K!</div></div>
                ...
                <div class="options">
                    <p>
                        <input class="radiostyle" type="radio" name="isRecommend" value="0" <c:if test="${businessChinmedichenacare.isRecommend == 0 }"> checked </c:if> > 否<br><br>
                        <input class="radiostyle" type="radio" name="isRecommend" value="1" <c:if test="${businessChinmedichenacare.isRecommend == 1 }"> checked </c:if> > 是<br>
                    </p>
                </div>
                ...
                <div class="options">
                    <p>
                        ...
                        <input class="radiostyle" type="radio" name="publishState" value="0" <c:if test="${businessChinmedichenacare.publishState == 0 }"> checked </c:if> >立即发布<br><br>
                        </shiro:hasPermission>
                        <shiro:hasPermission name="care_wait_publish">
                        <input class="radiostyle" type="radio" name="publishState" value="1" <c:if test="${businessChinmedichenacare.publishState == 1 }"> checked </c:if> >暂缓发布<br><br>
                        </shiro:hasPermission>
                        <input class="radiostyle" type="radio" name="publishState" value="2" <c:if test="${businessChinmedichenacare.publishState == 2 }"> checked </c:if> >待审核<br><br>
                    </p>
                </div>
