...
<div class="wrapper wranews">
    <div class="newsrel">
        <form id="addForm" method="post" action="<%=ctx %>/business/businessUser/saveCommunity.do">
    	<div class="header-public"><span class="return" onclick="history.go(-1)"></span>添加社区报员工信息</div>
        ...
        <div class="cont-l">
            ...
            <h2 class="title">年龄<label for="age" class="error success"></label></h2>
            ...
            <h2 class="title">籍贯<label for="hometown" class="error success"></label></h2>
            <input style="width:100px;" class="iptnewtit" type="text" id="hometown" name="hometown" placeholder='' /><br>
            <div class="line2"></div>
            
            <h2 class="title">民族<label for="nation" class="error success"></label></h2>
            ...
            <h2 class="title">人员昵称<font color="red">*</font><label for="nickname" class="error success"></label></h2>
            <input style="width:300px;" class="iptnewtit" type="text" id="nickname" name="nickname" placeholder='' /> <label id="nickNameIsExist"></label>
           ...
           <input type="hidden" name="uploadField" id="uploadField" value="">
            ...
            <div class="submtpres">
                ...
                <!-- <input id="qrbutSubmit" type="submit" name="" value="确认提交" style="display:none"/> -->
            </div>
        </div>
    	</form>
    </div>
