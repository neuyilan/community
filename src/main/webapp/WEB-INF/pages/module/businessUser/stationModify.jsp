...
<div class="wrapper wranews">
    <div class="newsrel">
        <form id="addForm" modelAttribute="businessUser" method="post" action="updateStation.do">
    	<div class="header-public"><span class="return" onclick="history.go(-1)"></span>修改驿站员工信息</div>
        <div class="cont-l">
        <input type="hidden" name="userId" id="userId" value="${businessUser.userId }" />
            ...
            <h2 class="relran">年龄<font color="red">*</font><label for="age" class="error success"></label></h2>
            ...
            <div style="position: relative;">
	            ...
	            <input type="hidden" id="rights" name="rights" value="-1" />
            ...
            <%-- ${fn:replace(businessUser.rightsInfo, '-', '<br />')} --%>
            <div class="line2"></div>
            ...
            <h2 class="relran">头像<font color="red">*</font></h2>
           ...
           <h2 class="newscont">交流话术<font color="red">*</font><label for="comWord" class="error success"></label></h2>
            ...
            <div class="options">
            	  <p>
            	      <input class="radiostyle" type="radio" id="isGirl1" name="isGirl" value="0" <c:if test="${businessUser.isGirl == 0 }"> checked </c:if> >否<br><br>
            	      <input class="radiostyle" type="radio" id="isGirl2" name="isGirl" value="1" <c:if test="${businessUser.isGirl == 1 }"> checked </c:if> >是<br>
          	      </p>
            </div> 
            ...
            <div class="options">
            	  <p>
            	      <input type="radio" name="state" class="radiostyle" id="state1" value="0" <c:if test="${businessUser.state == 0 }"> checked </c:if> />启用<br>
