...
<div class="wrapper wranews">
    <div class="newsrel">
        <form id="addForm" method="post" action="<%=ctx %>/business/businessUser/saveStation.do">
    	<div class="header-public"><span class="return" onclick="history.go(-1)"></span>添加驿站员工信息</div>
        ...
        <div class="cont-l">
            ...
            <div class="options">
            	  <p>
            	      ...
            	      <input class="radiostyle" type="radio" id="isMarriage2" name="isMarriage" checked value="1">未婚<br>
          	      </p>
            </div>
            <div class="line2"></div>
           ...
           <input type="hidden" name="uploadField" id="uploadField" value="">
            ...
            <div class="options">
            	  <p>
            	      <input class="radiostyle" type="radio" id="isGirl1" name="isGirl" value="0" checked >否<br><br>
            	      <input class="radiostyle" type="radio" id="isGirl2" name="isGirl" value="1">是<br>
          	      </p>
            </div> 
