...
<div class="wrapper wranews">
    <div class="newsrel">
        <form id="addForm" method="post" action="<%=ctx %>/business/businessUser/saveOperation.do">
    	<div class="header-public"><span class="return" onclick="history.go(-1)"></span>添加运营员工信息</div>
        ...
        <div class="cont-l">
           ...
           <div style="position: relative;">
            ...
            <h2 class="relran">头像<label for="avatar" class="error success"></label></h2>
           ...
           <input type="hidden" name="uploadField" id="uploadField" value="">
            ...
            <h2 class="newscont">人员简介<label for="userBrief" class="error success"></label></h2>
