...
<div class="wrapper wranews">
    <div class="newsrel">
        <form id="addForm" method="post" action="<%=ctx %>/business/businessDepartment/update.do">
        ...
        <input type="hidden" name="orgType" id="orgType" value="${businessDepartment.orgType }"/>
         	<h2 class="title">部门名称<label for="depName" class="error success"></label></h2>
            <input style="width:300px;" class="iptnewtit" type="text" id="depName" name="depName" placeholder='' value="${businessDepartment.depName }" />
            <br>
            <h2 class="title">部门描述<label for="depDesc" class="error success"></label></h2>
            <input class="iptnewtit" type="text" id="depDesc" name="depDesc" placeholder='' value="${businessDepartment.depDesc }" />
