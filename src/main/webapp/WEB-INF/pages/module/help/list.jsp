...
<head>
	...
	<script type="text/javascript">
            ...
            function delHelp(id) {
                var flag = window.confirm("是否删除此求助信息！");
                if(flag) {
		...
		<div class="mainr">
			...
			<div class="scroll">
				<div class="scroll-box">
					<ul id="oneul">
						<li id="state_" class="active navlist"><a href="javascript:;"><span>全部求助</span><b class="donbut"><i></i></b></a>
		            	...
		            	<a class="nopotr" href="javascript:;">
							...
							<div class="operate">
								<shiro:hasPermission name="help_view_detail">
									<span class="see" id="block5"  title="查看求助详情"  onclick="javascript: window.location.href='getHelpCommentList.do?helpId=${help.helpId }'"></span>
								</shiro:hasPermission>
								<shiro:hasPermission name="help_delete">
									<span id="text1" class="del" title="删除求助" onclick="delHelp('${help.helpId}');"></span>
		                    	</shiro:hasPermission>
		                    </div>
		                </a>
		            </div>
					...
					if (rows.length > 0) {
						...
						for (var i = 0; i < rows.length; i++) {
							...
							var htmlDom = ''
									...
									+'<div class="operate">'
									<shiro:hasPermission name="help_view_detail">
									+'<span class="see" id="block5" title="查看求助详情"  onclick="window.location.href=\'getHelpCommentList.do?helpId='+row.helpId+'\'"></span>'
									</shiro:hasPermission>
									<shiro:hasPermission name="help_delete">
									+'<span id="text1" class="del" title="删除求助" onclick="delHelp('+row.helpId+');"></span>'
									</shiro:hasPermission>
									+'</div>'
									+'</a>'
									+'</div>';
