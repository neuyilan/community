...
<script type="text/javascript">
        ...
        function delExpendestates(id) {
            var flag = window.confirm("是否删除此求助扩散信息！");
            if(flag) {
...
<body style="background: #fff;">
	<div class="wrapper" style="overflow:visible;">
		<div class="header-public">
			<span class="return" onclick="history.go(-1)"></span>求助详情
		</div>
		<div class="review" style="top:57px;  position:relative;">
			<div class="review-t">
				<h2 class="tiele">${businessHelp.helpTitle}</h2>
					...
					求助时间：<span class="com" style="font-size:16px; color:#000;"><time><fmt:formatDate value="${businessHelp.helpTime }" pattern="yyyy-MM-dd HH:mm" /></time></span>
					</div>
