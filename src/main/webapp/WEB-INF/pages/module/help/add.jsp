    ...
    <div class="wrapper wranews">
        ...
        <form id="ff" action="${ctx}/business/businessHelp/save.do" method="post">
            ...
            <div class="cont-l">                
			    ...
			    <input type="hidden" class="iptnewtit" name="helperId" id="helperId"> <%--求助人ID--%>
                <input type="hidden" class="iptnewtit" name="helperName" id="helperName"> <%--求助人姓名--%>
                <input type="hidden" class="iptnewtit" name="estateName" id="estateName"> <%--求助小区--%>
                <input type="hidden" class="iptnewtit" name="estateId" id="estateId"> <%--求助小区ID--%>      
			                    
                <h2 class="relran y-fbes-bdr">求助范围<label for="isExpend" class="error success"></label></h2>
	            <div style="position:relative;">
	            	<span class="ranbut radiusbox" id="showScopeLayer">点击选择求助范围</span>
