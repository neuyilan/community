...
<form id="ff" action="save.do" method="post">
    <div class="wrapper wranews">
        <div class="newsrel">
            <div class="header-public"><span class="return" onclick="history.go(-1);"></span>发布健康饮食</div>
            <div class="cont-l">
                
                <h2 class="relran">健康饮食标题<label for="healTitle" class="error success"></label></h2>
                <input class="iptnewtit" type="text" name="healTitle" id="healTitle" placeholder='请输入健康饮食标题24字以内' />
                
                <h2 class="relran">健康饮食简介<label for="brief" class="error success"></label></h2>
                <input class="iptnewtit" type="text" name="brief" id="brief" placeholder='请输入健康饮食简介28字以内' />
                
                <h2 class="relran">健康饮食内容<label for="healContent" class="error success"></label></h2>
                <%--文本编辑器--%>
                <!--style给定宽度可以影响编辑器的最终宽度-->
                <textarea id="healContent" name="healContent" type="text/plain" style="width:1024px;height:500px;"></textarea>
                ...
                <h2 class="relran">医师头像<label for="avatar" class="error success"></label></h2>
                 <div style=" overflow:hidden;"><img id="avatarBtn" src="${ctx}/images/icon/add.jpg" width="100" height="100"  style="float:left; padding-right:10px;"><div style="color:#000; padding-top:26px;">请上传【宽100PX、高100PX】jpg格式图片<br>图片大小不能超过20K!</div></div>
