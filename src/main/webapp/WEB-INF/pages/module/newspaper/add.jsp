...
<div class="wrapper wranews">
    <div class="newsrel">
        <div class="header-public"><span class="return" onclick="history.go(-1);"></span>新增电子报</div>
        <div class="cont-l">
            ...
            <div style="position:relative;">
	            ...
	            <lable style="position: absolute; top: 10px; left: 160px;"  id="titleShow"></lable>
            </div>
            
            <h2 class="relstatus" style="font-weight: bold;">封面展示<label for="pic" class="error success"></label></h2>
            <div id="divImg" style=" overflow:hidden;"><img id="picBtn" src="${ctx}/images/icon/add.jpg" width="100" height="100" style="float:left; padding-right:10px;"></div>
            ...
            <input class="iptnewtit" type="text" id="url" name="url"/>
...
<!-- <div id="setTimeLayer" class="busswi5 s-xw-bu">
    <div id="setTimeBar" class="sidebar5 s-xw-si">
        <a id="close5" title="关闭" class="s-xw-cl" href="javascript:;" onclick="$('#setTimeLayer').fadeOut('slow');"></a>
        <h2 class="tit5">设定时间</h2>
        <div id="wrapper-250">
            <ul class="accordion5"><div id="datepicker"></div></ul>
        </div>
        <div class="s-xw-zd">
   		<div class="link6"></div>
       	<div class="submtpres">
               <input id="qrbut7" type="button"  id="setTimeOk" value="确定" />
               <input id="zsbut7" type="button"  id="setTimeCancel"value="取消"  />
       	</div>
		</div>
    </div>
</div> -->
