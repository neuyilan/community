...
<body class="bagcolr">
<form id="ff" action="${ctx}/business/businessAnno/updatePropAnno.do" method="post">
<div class="wrapper wranews">
    <div class="newsrel">
        ...
        <input type="hidden" name="annoId" id="annoId" value="${businessAnno.annoId }" />
            ...
            <input class="iptnewtit" type="text" id="annoTitle" name="annoTitle" placeholder='请输入公告标题24字以内' value="${businessAnno.annoTitle }" />
            <br /><br />
            ...
            <div style="position:relative;">
            	...
            	<input type="hidden" id="annoBuilding" name="annoBuilding" value="${businessAnno.annoBuilding }" />
            ...
            <div style="position:relative;">
	            <span class="ranbut radiusbox" id="annoTypeBtn">点击选择类型</span> -->
	            <input type="hidden" id="annoType" name="annoType" value="${businessAnno.annoType }"/>
	            <%-- <lable style="position: absolute; top: 10px; left: 160px;"  id="annoTypeShow">
	            	<c:if test="${businessAnno.annoType == 0 }">通知类公告</c:if>
	            	<c:if test="${businessAnno.annoType == 1 }">信息传达类公告</c:if>
	            </lable>
            </div> --%>
            ...
            <div id="importantline2" style="display: none;" class="line2"></div>
            <h2 id="importanth2" style="display: none;" class="relstatus" style="font-weight: bold;">是否重要通知<label for="isImportant" class="error success"></label></h2>
            <div id="importantdiv" style="display: none;" class="options">
                <p>
                    <label>
                        <input class="radiostyle" type="radio" name="isImportant" value="0" id="RadioGroup1_0" onclick="importantSel(0)" <c:if test="${businessAnno.isImportant == 0 }"> checked </c:if> >
                        否</label>
                    <br><br>
                    <label>
                        <input class="radiostyle" type="radio" name="isImportant" value="1" id="RadioGroup1_1" onclick="importantSel(1)" <c:if test="${businessAnno.isImportant == 1 }"> checked </c:if> >
                        是</label>
                    <br>
                </p>
            </div>
            <div id="setTimeDiv" 
            	<c:if test="${businessAnno.isImportant == 1 }"> style="display: block;" </c:if>
            	<c:if test="${businessAnno.isImportant == 0 }"> style="display: none;" </c:if> >
	            ...
	            <input type="hidden" name="setTime" id="setTime" value="${businessAnno.setTime }" />
	            <span id="setTimeShow">${businessAnno.setTime }</span>
			</div>
            <div class="submtpres">
        ...
        <div id="wrapper-250">
	          <ul class="accordion5">
	          		<li id="one2" class="files">
	                    <input class="radiostyle2" type="radio" value="0" ${businessAnno.annoType == 0?"checked":""} name="annoTypeRadio" onclick="checkedRadio(this, 'annoType','通知类公告');">
	                    <a href="#one">通知类公告</a>
	                </li>
	                <li id="two2" class="mail">
	                    <input class="radiostyle2" type="radio" value="1" ${businessAnno.annoType == 1?"checked":""}  name="annoTypeRadio" onclick="checkedRadio(this,'annoType','信息传达类公告');">
...
<!-- 设定时间开始 -->
<div id="setTimeLayer" class="busswi3">
    <div id="setTimeBar" class="sidebar3">
        <a id="close3" class="close_effect" href="javascript:;"></a>
