...
<body class="bagcolr">
<form id="ff" action="${ctx}/business/businessAnno/updateOperationAnno.do" method="post">
    ...
    <div class="newsrel">
        ...
        <input type="hidden" name="annoId" id="annoId" value="${businessAnno.annoId }" />
            ...
            <div style="position:relative;">
	            ...
	            <input type="hidden" name="annoType" id="annoType" value="${businessAnno.annoType }"/>
	            <lable style="position: absolute; top: 10px; left: 160px;" id="annoTypeShow">
	            	<c:if test="${businessAnno.annoType == 2 }">内部公告</c:if>
	            	<c:if test="${businessAnno.annoType == 3 }">系统公告</c:if>
	            </lable>
            </div>
            <div class="line2"></div>
            ...
            <div id="userLeveldiv" style="position:relative;">
            	...
            	<input type="hidden" name="userLevel" id="userLevel" value="${businessAnno.userLevel }"/>
	            <lable style="position: absolute; top: 10px; left: 160px;"  id="userLevelShow">
	            	<c:if test="${businessAnno.userLevel == 0 }">注册用户</c:if>
					<c:if test="${businessAnno.userLevel == 1 }">验证用户</c:if>
	            </lable>
            </div>
		    <div class="line2"></div>
            ...
            <%--文本编辑器--%>
            <textarea name="annoContent" id="annoContent" rows="5" cols="160">${businessAnno.annoContent }</textarea>
            
            <h2 class="relstatus" style="font-weight: bold;">是否推送<label for="isPush" class="error success"></label></h2>
            <div class="options">
                <p>
                    <label>
                        <input class="radiostyle" type="radio" name="isPush" value="1" id="isPush_1"  onclick="IsPash()">
                        	是</label>　　
        ...
        <div id="wrapper-250">
	          <ul class="accordion5">
	          		<li id="one2" class="files"> 
	                    <input class="radiostyle2" type="radio" value="2"  ${businessAnno.annoType == 2?"checked":""} name="annoTypeRadio" onclick="checkedRadio(this, 'annoType','内部公告');">
	                    <a href="#one">内部公告</a>
	                </li>
	                <li id="two2" class="mail">
	                    <input class="radiostyle2" type="radio" value="3" ${businessAnno.annoType == 3?"checked":""} name="annoTypeRadio" onclick="checkedRadio(this,'annoType','系统公告');">
	                    <a href="#two">系统公告</a>
	                </li>
	          </ul>
        </div>
...
<div id="userLevelLayer" class="busswi y-fbes-jm">
	<div id="userLevelBar" class="sidebar y-fbes-jms">
        ...
        <div id="wrapper-250">
	          <ul class="accordion5">
	          		<li id="one2" class="files">
	                    <input class="radiostyle2" type="radio"  ${businessAnno.userLevel == 0?"checked":""} value="0" name="userLevel1" onclick="checkedRadio(this, 'userLevel','注册用户');">
	                    <a href="#one">注册用户</a>
	                </li>
	                <li id="two2" class="mail">
	                    <input class="radiostyle2" type="radio" ${businessAnno.userLevel == 0?"checked":""} value="1" name="userLevel1" onclick="checkedRadio(this,'userLevel','验证用户');">
	                    <a href="#two">验证用户</a>
	                </li>
	                <!-- 
	                <li id="two2" class="mail">
...
<script type="text/javascript">
    ...
    $(function() {
      ...
      //关闭内部公告范围层
        $('#closeInnerScope').click(function() {
