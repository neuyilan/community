...
<body class="bagcolr">
<form id="ff" action="${ctx}/business/businessAnno/saveStationAnno.do" method="post">
<div class="wrapper wranews">
    <div class="newsrel">
        ...
        <div class="cont-l">
            ...
            <input type="hidden" name="annoContent" id="annoContent" value="">
            ...
            <div class="options">
                <p>
                    <label><input class="radiostyle" type="radio" name="isRecommend" value="1" id="isRecommend_1">&nbsp;首页焦点图</label>
                    <em style="color:#000;">将推送至焦点图管理列表，在焦点图管理中进行焦点图制作上传，审核通过后发布至焦点图位置</em><br><br>
                    <label><input class="radiostyle" type="radio" name="isRecommend" value="2" id="isRecommend_2">&nbsp;首页全网焦点图</label>
                    <em style="color: #000;">　将推送至全网焦点图管理列表，在全网焦点图管理中进行全网焦点图制作上传，审核通过后发布至全网焦点图位置</em><br><br>
                    <label><input class="radiostyle" type="radio" name="isRecommend" value="0" id="isRecommend_0" checked >&nbsp;以上都不选</label><br>
                </p>
            </div>
