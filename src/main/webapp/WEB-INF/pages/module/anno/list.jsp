...
<html>
    ...
    <div class="wrapper wrapos">
        ...
        <div class="mainr">
	        ...
	        <div class="column">
	        	<!-- 发布公告开始 -->
	        	<shiro:hasPermission name="anno_add_anno">
	        	<div class="manbox" style="margin-left:0;">
	            	<a class="nopotr" href="javascript:window.location.href='<%=ctx %>/business/businessAnno/add.do';" style="cursor:pointer;">
	                    <div class="relnews">
	            ...
	            <c:forEach items="${baseBean.list }" var="anno" varStatus="key">
	        			...
	        			<shiro:lacksPermission name="anno_add_anno">
		            	...
		            	<a class="nopotr" href="javascript:;">
		                    ...
		                    <div class="operate">
		                    	<shiro:hasPermission name="anno_view_detail">
		                    		<span class="see"  title="查看公告详情"  id="block5" onclick="seeDetail('${anno.annoId}')"></span>
		                    	</shiro:hasPermission>
		                    	<c:if test="${anno.publishState != 0 }">
		                    		<shiro:hasPermission name="anno_edit_anno">
		                    			<span class="edit" title="编辑公告" onclick="window.location.href='${ctx}/business/businessAnno/modify.do?annoId=${anno.annoId}'"></span>
		                    		</shiro:hasPermission>
		                    	</c:if>
		                    	<shiro:hasPermission name="anno_delete_anno">
...
<script type="text/javascript">
    ...
    function jump(pageNo) {
    	...
    	$.ajax({
            url: '<%=path %>/business/businessAnno/getPageList.do',
            type: 'post',
            dataType: 'json',
            data: params,
            cache: false,
            success: function (data) {
                ...
                if(rows.length > 0) {
                	for(var i=0;i<rows.length;i++) {
    		            ...
    		            <shiro:hasPermission name="anno_edit_anno">
    		            +(row.publishState != 0?'<span class="edit" title="编辑公告" onclick="window.location.href=\'${ctx}/business/businessAnno/modify.do?annoId='+row.annoId+'\'"></span>':'')
    		            </shiro:hasPermission>
    		            <shiro:hasPermission name="anno_delete_anno">
      	 ...
      	 dataType: 'json',
      	  ...
      	  success: function(data) {
	            ...
	            if(publishState == 0) {
	            	...
	            	publishState = '待审核';
	            	<shiro:hasPermission name="anno_audit_anno">
    ...
    function editAnno(annoId) {
    	window.location.href = "modify.do?annoId="+annoId;
    }
