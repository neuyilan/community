    ...
    <div class="wrapper wranews">
        <div class="newsrel">
            ...
            <div class="cont-l">
                ...
                <input class="iptnewtit" type="text" name="title" placeholder='请输入焦点图名称'  value="${businessFocus.title}"/>
	            ...
	            <div style="position:relative;">
		            ...
		            <input type="hidden" id="focusScope" name="focusScope" value="${scope}" />
		            <input type="hidden" id="focusScopeInfo" name="focusScopeInfo" value="${businessFocus.focusScope}" />
		            <lable style="position: absolute; top: 10px; left: 160px;"  id="scopeShow">${businessFocus.focusScope}</lable>
	            </div> 
                ...
                <c:if test="${businessFocus.ishtml==1}">   
	                ...
	                <input class="iptnewtit" type="text" name="pageUrl" placeholder='请输入展示内容的链接地址'  value="${businessFocus.pageUrl}"/>
                </c:if>
