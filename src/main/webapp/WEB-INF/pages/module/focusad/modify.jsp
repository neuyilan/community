...
<form id="ff"  action="update.do" method="post">
    ...
    <div class="wrapper wranews">
        <div class="newsrel">
            <div class="header-public"><span class="return" onclick="history.go(-1);"></span>编辑全网焦点图</div>
            <div class="cont-l">
                <h2 class="relran" style="font-weight: bold;">全网焦点图名称<label for="title" class="error success"></label></h2>
                <input class="iptnewtit" type="text" name="title" placeholder='请输入全网焦点图名称'  value="${businessFocusAd.title}"/>
