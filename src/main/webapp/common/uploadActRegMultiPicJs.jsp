...
<div id="picUploadLayer" class="busswi5 s-xw-bu">
	<div id="picUploadBar" class="sidebar5 s-xw-si s-xw-show">
		<a id="close5" title="关闭" href="javascript:;"
			onclick="$('#picUploadLayer').fadeOut('slow');"></a>
	...
	new AjaxUpload(button, {
	    ...
	    onComplete: function(file, response) {
        	...
        	if(imgpath != null || imgpath != ""){
        		var htmlDom = '<label id="img_'+imgpath.substring(imgpath.lastIndexOf('/')+1,imgpath.lastIndexOf('.'))+'"><img class="lilabel" src="<%=ctx%>'+imgpath+'" width="190" height="250" style="float:left; padding-right:40px;"></label>';
