...
public class BusinessBreakAudio implements java.io.Serializable{
	
	//别名
	public static final String TABLE_ALIAS = "BusinessBreakAudio";
	...
	public boolean equals(Object obj) {
		if(obj instanceof BusinessBreakAudio == false) return false;
		if(this == obj) return true;
		BusinessBreakAudio other = (BusinessBreakAudio)obj;
