...
public class BusinessRepairComment implements java.io.Serializable {

	// 别名
	public static final String TABLE_ALIAS = "BusinessRepairComment";
	...
	public BusinessRepairComment() {
	}

	public BusinessRepairComment(java.lang.Integer commentId) {
	...
	public boolean equals(Object obj) {
		if (obj instanceof BusinessRepairComment == false)
			return false;
		if (this == obj)
			return true;
		BusinessRepairComment other = (BusinessRepairComment) obj;
