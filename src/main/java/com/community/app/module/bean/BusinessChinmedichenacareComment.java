...
public class BusinessChinmedichenacareComment implements java.io.Serializable {

	// 别名
	public static final String TABLE_ALIAS = "BusinessChinmedichenacareComment";
	...
	public BusinessChinmedichenacareComment() {
	}

	public BusinessChinmedichenacareComment(java.lang.Integer commentId) {
	...
	public boolean equals(Object obj) {
		if (obj instanceof BusinessChinmedichenacareComment == false)
			return false;
		if (this == obj)
			return true;
		BusinessChinmedichenacareComment other = (BusinessChinmedichenacareComment) obj;
