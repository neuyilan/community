...
public interface BusinessAnnoSupportService {
	 ...
	 * @throws ServiceException
	 */	
	public List<BusinessAnnoSupport> findByMap(final Map<String, Object> paramMap) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */	
	public List<BusinessAnnoSupport> findByMap(final Map<String, Object> paramMap, final Integer limit) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public void save(final BusinessAnnoSupport entity) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public void update(final BusinessAnnoSupport entity) throws ServiceException;
