...
public interface BusinessActivityParticipateService {
	 ...
	 * @throws ServiceException
	 */	
	public List<BusinessActivityParticipate> findByMap(final Map<String, Object> paramMap) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */	
	//public List<BusinessActivityParticipate> findByMap(final Map<String, Object> paramMap, final Integer limit) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public void save(final BusinessActivityParticipate entity) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public void update(final BusinessActivityParticipate entity) throws ServiceException;
