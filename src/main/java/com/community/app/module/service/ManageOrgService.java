...
public interface ManageOrgService {
	 ...
	 * @throws ServiceException
	 */	
	public List<ManageOrg> findByMap(final Map<String, Object> paramMap) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */	
	public List<ManageOrg> findByMap(final Map<String, Object> paramMap, final Integer limit) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public void save(final ManageOrg entity) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public void update(final ManageOrg entity) throws ServiceException;
