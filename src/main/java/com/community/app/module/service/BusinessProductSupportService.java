...
public interface BusinessProductSupportService {
	 ...
	 * @throws ServiceException
	 */	
	public List<BusinessProductSupport> findByMap(final Map<String, Object> paramMap) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */	
	public List<BusinessProductSupport> findByMap(final Map<String, Object> paramMap, final Integer limit) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public void save(final BusinessProductSupport entity) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public void update(final BusinessProductSupport entity) throws ServiceException;
