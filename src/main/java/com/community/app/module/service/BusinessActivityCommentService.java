...
public interface BusinessActivityCommentService {
	 ...
	 * @throws ServiceException
	 */	
	public List<BusinessActivityComment> findByMap(final Map<String, Object> paramMap) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */	
	//public List<BusinessActivityComment> findByMap(final Map<String, Object> paramMap, final Integer limit) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public void save(final BusinessActivityComment entity) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public void replySave(final BusinessActivityComment entity) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public void update(final BusinessActivityComment entity) throws ServiceException;
