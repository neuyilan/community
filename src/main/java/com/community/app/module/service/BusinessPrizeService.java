...
public interface BusinessPrizeService {
	 ...
	 * @throws ServiceException
	 */	
	//public List<BusinessPrize> findByMap(final Map<String, Object> paramMap, final Integer limit) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public void save(final BusinessPrize entity) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public void update(final BusinessPrize entity) throws ServiceException;
