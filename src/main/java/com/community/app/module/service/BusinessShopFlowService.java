...
public interface BusinessShopFlowService {
	 ...
	 * @throws ServiceException
	 */	
	public List<BusinessShopFlow> findByMap(final Map<String, Object> paramMap) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */	
	//public List<BusinessShopFlow> findByMap(final Map<String, Object> paramMap, final Integer limit) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public void save(final BusinessShopFlow entity) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public void update(final BusinessShopFlow entity) throws ServiceException;
