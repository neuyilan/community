...
public interface BusinessPropertyMaterialService {
	 ...
	 * @throws ServiceException
	 */	
	public List<BusinessPropertyMaterial> findByMap(final Map<String, Object> paramMap) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */	
	//public List<BusinessPropertyMaterial> findByMap(final Map<String, Object> paramMap, final Integer limit) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public void save(final BusinessPropertyMaterial entity) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public void update(final BusinessPropertyMaterial entity) throws ServiceException;
