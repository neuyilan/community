...
public interface BusinessShopGoodsService {
	 ...
	 * @throws ServiceException
	 */	
	public List<BusinessShopGoods> findByMap(final Map<String, Object> paramMap) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */	
	//public List<BusinessShopGoods> findByMap(final Map<String, Object> paramMap, final Integer limit) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public void save(final BusinessShopGoods entity) throws ServiceException;
	 ...
	 * @throws ServiceException
	 */
	public void update(final BusinessShopGoods entity) throws ServiceException;
