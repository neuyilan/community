...
//    } 
	...
	public static void main(String[] args) {
		Pattern pattern = Pattern.compile("1\u548C9");  
		Properties p = propertiesUtil.getProperties("limit.properties");
		String tomorrow = p.getProperty("tomorrow");
		System.out.println(tomorrow);
		Matcher matcher = pattern.matcher(p.getProperty("tomorrow")); 
		boolean b= matcher.matches();
		System.out.println(matcher.matches());
		System.out.println("1和9".equals(tomorrow));
		System.out.println(tomorrow.contains("和"));
	}
