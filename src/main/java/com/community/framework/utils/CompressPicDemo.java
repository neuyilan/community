...
//					double rate2 = ((double) img.getHeight(null)) / (double) outputHeight + 0.1;
					double rate1 = ((double) img.getWidth(null))	/ (double) (img.getWidth(null)*0.7) + 0.1;
					double rate2 = ((double) img.getHeight(null)) / (double) (img.getWidth(null)*0.7) + 0.1;  
...
//		this.outputDir = outputDir;
	...
	public static void main(String[] arg) {
		...
		for (int i = 0; i < 100; i++) {
			...
			mypic.compressPic( "e:\\1.jpg", "e:\\test\\r1" + i + ".jpg",
					120, 120, true);
