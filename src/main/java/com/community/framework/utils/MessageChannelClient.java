...
public class MessageChannelClient {
	 ...
	 * 构造函数
	 */
	public MessageChannelClient() throws UnsupportedEncodingException {
	 ...
	 * 构造函数
	 */
	public MessageChannelClient(String sn, String password) throws UnsupportedEncodingException {
		this.sn = sn;
